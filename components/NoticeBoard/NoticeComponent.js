...
import { View, Text, StyleSheet, Platform, TouchableHighlight, Alert } from 'react-native';
...
export default class NoticeComponent extends Component {
  ...
  _removeText = () => {
    //const _this = this;
    //var url = "https://172.20.10.3:8088/api/boardcontents/";
    var url = 'https://' + CommonConf.urlHost + ':8088/ss/api/deleteAllboardcontents/';
      ...
      return (
            <Card>
              <CardItem>
                ...
                <Right>
                    <TouchableHighlight onPress={() => this._goDelBtn()}>
                        <MaterialCommunityIcons style = {styles.delBtn} name='delete' size={30}/>
                    </TouchableHighlight>
                </Right>
              </CardItem>
              <CardItem >
